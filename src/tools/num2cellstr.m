...
%
%    NUM2CELLSTR(X, P, S) same as above but includes a suffix string to
%    each cell.
%
...
function [c] = num2cellstr(a, prec, suffix)
...
c = cellstr(reshape(sprintf(f, a),[l, n])');
for i = 1:n
   c{i} = [strtrim(c{i}) ' ' suffix]; 
end
